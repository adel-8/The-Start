...
<head>
    ...
    {{-- Premium Fonts: Cormorant Garamond (EN headings) + Cairo (Arabic) --}}
    ...
    [dir="rtl"] textarea,.arabic { font-family:'Cairo',sans-serif; }
    ...
    .cta-section {
        background:linear-gradient(135deg,#0f0f0f,#1a1410,#0f0f0f,#221808);
    ...
    .hero-slide-overlay {
        ...
        background:linear-gradient(to right,rgba(0,0,0,.62) 0%,rgba(0,0,0,.15) 55%,transparent 100%);
    }
    [dir="rtl"] .hero-slide-overlay {
        background:linear-gradient(to left,rgba(0,0,0,.62) 0%,rgba(0,0,0,.15) 55%,transparent 100%);
    }
    ...
    /* ── Dot indicators ── */
    .slider-dots .dot { transition:width .35s ease,background .35s ease; }
    .slider-dots .dot.active { width:1.5rem!important; background:var(--gold); }
    </style>
