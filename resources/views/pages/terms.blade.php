...
<style>
    ...
    .terms-content h2 { font-size: 1.5rem; margin: 1.5rem 0 1rem; color: #1a1a1a; }
    .terms-content h3 { font-size: 1.25rem; margin: 1.25rem 0 0.75rem; color: #1a1a1a; }
    .terms-content ul, .terms-content ol { margin: 1rem 0 1rem 1.5rem; }
    .terms-content li { margin-bottom: 0.5rem; }
    .terms-content a { color: #645F7D; text-decoration: underline; }
    ...
    @media (max-width: 768px) {
        .terms-page { margin: 1.5rem auto; padding: 0 1rem; }
