...
<style>
    ...
    .privacy-content h2 { font-size: 1.5rem; margin: 1.5rem 0 1rem; color: #1a1a1a; }
    .privacy-content h3 { font-size: 1.25rem; margin: 1.25rem 0 0.75rem; color: #1a1a1a; }
    .privacy-content ul, .privacy-content ol { margin: 1rem 0 1rem 1.5rem; }
    .privacy-content li { margin-bottom: 0.5rem; }
    .privacy-content a { color: #645F7D; text-decoration: underline; }
    ...
    @media (max-width: 768px) {
        .privacy-page { margin: 1.5rem auto; padding: 0 1rem; }
        .privacy-content { padding: 1rem; }
        .privacy-page h1 { font-size: 1.5rem; }
    }
</style>
@endpush
