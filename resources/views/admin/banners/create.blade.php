...
@section('title', __('admin.add_banner'))

@section('content')
<div class="create-banner-header">
    <h1>{{ __('admin.add_banner') }}</h1>
...
<form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="banner-form">
    @csrf
    ...
    <div class="form-row">
        ...
        <div class="form-group">
            ...
            <small>{{ __('admin.link_help') }}</small>
    ...
    <div class="form-row">
        ...
        <div class="form-group">
            ...
            <select name="device_type" id="device_type">
                <option value="all" {{ old('device_type', 'all') == 'all' ? 'selected' : '' }}>{{ __('admin.all_devices') }}</option>
                <option value="mobile" {{ old('device_type') == 'mobile' ? 'selected' : '' }}>{{ __('admin.mobile') }}</option>
                <option value="desktop" {{ old('device_type') == 'desktop' ? 'selected' : '' }}>{{ __('admin.desktop') }}</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group">
        <label for="image">{{ __('admin.banner_image_required') }} *</label>
    ...
    <div class="form-actions">
        <button type="submit" class="btn-primary">{{ __('admin.save_banner') }}</button>
