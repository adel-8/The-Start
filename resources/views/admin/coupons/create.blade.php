...
<form action="{{ route('admin.coupons.store') }}" method="POST" class="coupon-form">
    ...
    <div class="form-row">
        <div class="form-group">
            ...
            <select name="discount_type" id="discount_type" required>
                ...
                <option value="fixed" {{ old('discount_type') == 'fixed' ? 'selected' : '' }}>{{ __('admin.fixed_amount') }}</option>
            </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" name="min_order_amount" id="min_order_amount" value="{{ old('min_order_amount') }}">
    ...
    <div class="form-row">
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" name="valid_to" id="valid_to" value="{{ old('valid_to') }}" required>
    ...
    <div class="form-row">
        ...
        <div class="form-group">
            ...
            <input type="number" name="total_usage_limit" id="total_usage_limit" value="{{ old('total_usage_limit') }}">
            <small>{{ __('admin.leave_blank_unlimited') }}</small>
        </div>
    </div>
    ...
    <div class="form-actions">
        <button type="submit" class="btn-primary">{{ __('admin.save_coupon') }}</button>
