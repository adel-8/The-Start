...
<div class="edit-category-header">
    <h1>{{ __('admin.edit_category') }}: {{ $category->name }}</h1>
    ...
    <div class="form-row">
        ...
        <div class="form-group">
            ...
            <select name="status" id="status">
                <option value="1" {{ old('status', $category->status) == '1' ? 'selected' : '' }}>{{ __('admin.active') }}</option>
                <option value="0" {{ old('status', $category->status) == '0' ? 'selected' : '' }}>{{ __('admin.inactive') }}</option>
            </select>
        </div>
    </div>

    <div class="form-actions">
        <button type="submit" class="btn-primary">{{ __('admin.update_category') }}</button>
...
@push('scripts')
<script>
    // Optional: auto-generate slug from name if slug field is empty
